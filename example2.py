...
# moving sparklers, sub classing Sparkler to add movement
class CirclingSparkler(Sparkler):
    ...
    def __init__(self, size, colors, origin, radius,
        ...
        """CirclingSparkler object constructor
                ...
                origin: center of sparkler rotation in screen coordinates
...
def example2():
    ...
    sparkler1 = CirclingSparkler(500, (RED, YELLOW, BLUE), (400, 300), 200)
    
    sparkler2 = CirclingSparkler(500, (RED,), (400, 500), 150, speed=-2 * math.pi / 500)

    sparkler3 = CirclingSparkler(500, (BLUE, YELLOW,), (400, 400), 100,
                                 speed=3 * math.pi / 500,
                                 start_angle=2 * math.pi / 4)
